  ...
  render() {
    return (
      <ReactCardFlip isFlipped={this.state.isFlipped} flipDirection="vertical">
        <VideoItemFront confirmCopied = {this.confirmCopied} flipFunction = {this.handleLearnMore} rank = {this.props.rank} title={this.props.title} thumbnailUrl = {this.props.thumbnailUrl} topicName = {this.props.topicName} subtopicName = {this.props.subtopicName} videoId = {this.props.videoId} addedBy={this.props.addedBy}/>
